...
def paged_attention_v1_mixed(
    ...
    """Paged attention v1 with mixed block sizes (experimental dual KV blocks).
    
    Args:
        block_size_multipliers: [num_seqs] tensor where each element indicates
            how many kernel blocks correspond to one logical block.
        ...
        kernel_block_size: The underlying kernel block size (typically 16).
    """
    torch.ops._C.paged_attention_v1_mixed(
        out,
        query,
        key_cache,
        value_cache,
...
def paged_attention_v2_mixed(
    ...
    """Paged attention v2 with mixed block sizes (experimental dual KV blocks)."""
    torch.ops._C.paged_attention_v2_mixed(
        out,
        exp_sum,
        max_logits,
        tmp_out,
